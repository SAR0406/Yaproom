...
export type GamePhase = 'lobby' | 'setup' | 'instructions' | 'round_start' | 'action' | 'player_action' | 'timer' | 'guess' | 'voting' | 'vote' | 'reveal' | 'recap' | 'scoring' | 'next_round' | 'match_end';
...
export type ActionType = 'submit_description' | 'submit_answer' | 'submit_vote' | 'submit_guess' | 'submit_clue' | 'draw_stroke' | 'ready_up' | 'host_action';
...
export interface KeyCard {
    assignments: ('red' | 'blue' | 'bystander' | 'assassin')[];
}
...
export type ChaosEventType = 'screen_shake' | 'fake_ping' | 'bonus_round' | 'anonymous_mode' | 'role_swap' | 'double_points' | 'silence_player' | 'reverse_vote' | 'aura_surge' | 'cooked_mode';
export type ErrorCode = 'ROOM_FULL' | 'ROOM_LOCKED' | 'INVALID_CODE' | 'HOST_DISCONNECTED' | 'GAME_IN_PROGRESS' | 'PLAYER_KICKED' | 'PLAYER_BANNED' | 'INSUFFICIENT_PLAYERS' | 'ABUSIVE_LANGUAGE' | 'RATE_LIMIT' | 'UNKNOWN';
