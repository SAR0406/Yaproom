    ...
    <RoomLayout>
      {(room) => (
        <Card>
          ...
          <p className="mt-2 text-sm text-muted">Kick, mute, or ban disruptive players.</p>
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-muted">
                      {player.isHost ? 'Host' : 'Player'} · {player.isMuted ? 'Muted' : 'Live'}
                    </p>
                  </div>
